...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__overlay_bubble_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__data_mapStyle_js__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__title__ = __webpack_require__(4);
...
class Jumap {
    ...
    _setTitle() {
        if (this._option.title && !this._title) {
            this._title = new __WEBPACK_IMPORTED_MODULE_2__title__["a" /* Title */](this._option.title, this._id);
        }
    ...
    setOption(option) {
        ...
        // 设置底图样式
        this._bmap.setMapStyle(__WEBPACK_IMPORTED_MODULE_1__data_mapStyle_js__["a" /* default */][bmap.mapStyle]);
        // 鼠标滚动
...
Jumap.overlayFactory = {
    bubble: __WEBPACK_IMPORTED_MODULE_0__overlay_bubble_js__["a" /* default */]
    ...
    return class BubbleOverlay extends BMap.Overlay {
        ...
        _initContainer() {
            ...
            this._bmap.addEventListener('moveend', type => {
                ...
                __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this._container).selectAll("circle").attr('cy', d => d.position.y + type.target.offsetY).attr('cx', d => d.position.x + type.target.offsetX);
            });
        }
        _drawBubble() {
            // 转换坐标
            ...
            let g = __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this._container).append("svg").attr('width', '100%').attr('height', '100%').selectAll("g").data(this._data).enter().append('g');
            g.append("circle").attr('cy', d => d.position.y).attr('cx', d => d.position.x).attr('r', d => d.value).attr('fill', this._style.color);
            // 让气泡动起来
            window.setInterval(() => {
                __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this._container).selectAll("circle").transition().duration(500 / this._style.speed).attr('r', d => d.value * this._style.scale).transition().duration(500 / this._style.speed).attr('r', d => d.value);
        ...
        draw() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_d3__["select"](this._container).selectAll("circle").attr('cy', d => d.position.y - y).attr('cx', d => d.position.x - x);
        }
    };
});
